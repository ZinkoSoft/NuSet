...
namespace JamesZinkovitch.NuSet
{
    ...
    //       our case we chose NuSetterOptions.nuset. Note this file name appears in Editor.vsdir
    ...
    //          - "NuSetterOptions" - This is the base file name. New files will initially
    //             be named as NuSetterOptions1.nuset, NuSetterOptions2.nuset... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    NuSetterOptions.nuset|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - NuSetterOptions.nuset - our empty nuset file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidNuSetCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidNuSetCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidNuSetEditorFactory;
            return VSConstants.S_OK;
        }
